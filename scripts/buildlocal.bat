...
:build
    ...
    mkdir %dest%\Resources\stuff > NUL 2>NUL
    copy tmp\love2d\license.txt %dest%\Resources\stuff\love2dLicense.txt > NUL 2>NUL
    copy tmp\love2d\readme.txt %dest%\Resources\stuff\love2dReadMe.txt > NUL 2>NUL
    copy license %dest%\Resources\stuff\license.txt > NUL 2>NUL
