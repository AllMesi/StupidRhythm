...
CONFIG = {
    ...
    window = {icon = 'assets/images/icon.png'},
...
GameVars.inputPlace3 = {}
GameVars.inputPlace4 = {}

GameVars.inputPlace.y = 0
GameVars.inputPlace2.y = 0
GameVars.inputPlace3.y = 0
GameVars.inputPlace4.y = 0
GameVars.inputPlace.x = 0
GameVars.inputPlace2.x = 0
GameVars.inputPlace3.x = 0
GameVars.inputPlace4.x = 0
...
Sounds = {
    hitsound = love.audio.newSource('assets/sounds/hit.mp3', 'static'),
    hitsound2 = love.audio.newSource('assets/sounds/hit.mp3', 'static'),
    hitsound3 = love.audio.newSource('assets/sounds/hit.mp3', 'static'),
    hitsound4 = love.audio.newSource('assets/sounds/hit.mp3', 'static')
}
